...
public sealed class ExportDeleteCommand : ICommand
{
    private readonly ResultWindowViewModel _viewModel;
    public event EventHandler? CanExecuteChanged;

    public ExportDeleteCommand(ResultWindowViewModel viewModel)
    {
    ...
    {
        string content = string.Join(Environment.NewLine, _viewModel.DeletedRow.Select(a => a.RawContent.ToCsv()));
        try
        {
